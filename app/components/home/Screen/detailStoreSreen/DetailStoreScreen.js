    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.address}>
          <Text style={{color: '#535353'}}>{data.address}</Text>
        </View>

        <View style={styles.des}>
          <Text>
            {des}
            <TouchableOpacity onPress={desPress}>
              <Text style={{color: '#FC6011'}}>{see}</Text>
            </TouchableOpacity>
          </Text>
        </View>
        <View style={styles.tabs}>
          <TouchableOpacity
            style={styles.tab}
            onPress={() => navigation.navigate('ServiceNavi')}>
            <View>
              <Text>DỊCH VỤ</Text>
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.points}>
            <View style={{alignItems: 'center'}}>
              <View style={styles.point}>
                <Text style={{fontSize: 15}}>{comment.avgPoint}</Text>
              </View>
              <View>
      ...
      <View style={[styles.price, {display: total === 0 ? 'none' : 'flex'}]}>
        <View style={{flex: 1, justifyContent: 'center'}}>
          <Text style={{fontSize: 20, color: '#fff'}}>{total}.000</Text>
        </View>
        <View style={{marginVertical: '3%'}}>
          <TouchableOpacity
            ...
            <View>
              <Text style={{fontSize: 15}}>Chọn thời gian</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
