...
import { View, StyleSheet, Text, SafeAreaView, ScrollView, Alert, FlatList } from 'react-native';
            ...
            [
                ...
                },
                {
                    text: "Đồng ý", onPress: async () => {
                        let list = await createdetail(itemActiveone?.id, itemActivetwo?.id, date, route.params.service);
                        console.log(list);
